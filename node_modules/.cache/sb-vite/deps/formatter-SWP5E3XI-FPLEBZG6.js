    ...
    var xe = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports), pt = xe((r0, pu) => {
      ...
      var FD = Object.create, _r = Object.defineProperty, AD = Object.getOwnPropertyDescriptor, Gn = Object.getOwnPropertyNames, SD = Object.getPrototypeOf, xD = Object.prototype.hasOwnProperty, ht = (e, r) => function() {
        ...
        function n(C) {
          ...
          return { type: "group", id: o.id, contents: C, break: !!o.shouldBreak, expandedStates: o.expandedStates };
        }
        function u(C) {
...
`)) && O.expressions.every(_e);
        ...
        var Te = { Leading: 2, Trailing: 4, Dangling: 8, Block: 16, Line: 32, PrettierIgnore: 64, First: 128, Last: 256 }, je = (O, me) => {
...
`) : F(W);
        ...
        function ie(U, Z, se, fe, ge, he) {
          let we = U.getName(), ke = U.getParentNode(), Re = v(ke) && we === "callee", Ne = !!(Z && Z.assignmentLayout), Pe = he.body.type !== "BlockStatement" && he.body.type !== "ObjectExpression" && he.body.type !== "SequenceExpression", oe = Re && Pe || Z && Z.assignmentLayout === "chain-tail-arrow-chain", H = Symbol("arrow-chain");
        ...
        function m(b) {
          return ["superClass", "extends", "mixins", "implements"].filter((B) => !!b[B]).length > 1;
        }
        function C(b) {
        ...
        function f(P, $, D) {
          ...
          switch (T.kind) {
            ...
            case "OperationDefinition": {
              let m = $.originalText[g(T)] !== "{", C = !!T.name;
...
//# sourceMappingURL=formatter-SWP5E3XI-FPLEBZG6.js.map
