...
var withOutline = (StoryFn, context) => {
  let { globals: globals2 } = context, isActive = [true, "true"].includes(globals2[PARAM_KEY]), isInDocs = context.viewMode === "docs", outlineStyles = (0, import_preview_api.useMemo)(() => outlineCSS(isInDocs ? '[data-story-block="true"]' : ".sb-show-main"), [context]);
